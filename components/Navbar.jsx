...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#1C1678] border-b border-blue-500">
            ...
            {!session &&
              ...
              Object.values(providers).map((provider, index) => (
                <button
                  onClick={() => signIn(provider.id)}
                  key={index}
                  className="flex items-center text-white bg-red-700 hover:bg-red-900 hover:text-white rounded-md px-3 py-2"
                >
                  <span>Login or Register</span>
                </button>
              ))}
